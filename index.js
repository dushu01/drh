...
const modalMessageList = [
    { "number": 1, "message": "안녕하세요. 뚜루의 어드벤트 캘린더 페이지에 오신 것을 환영해요. 오늘 부터 매일 캘린더를 눌러보시면 사진과 글귀를 보실 수 있어요. 사진을 보고 정답을 맞춰주세요. 정답을 맞추시면 또 다른선물이 있어요. 정답의 힌트는 사진에만 있어요. 1일~22일까지 사진을 보고 정답을 맞춰주세요." },
